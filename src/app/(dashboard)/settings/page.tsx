...
export default function SettingsPage() {
  ...
  if (isError) return <div className="flex min-h-72 flex-col items-center justify-center text-center" dir="rtl"><AlertCircle className="mb-3 h-8 w-8 text-rose-400" /><p className="font-bold text-white">تعذر تحميل الإعدادات</p><p className="mt-1 text-sm text-muted-foreground">تحقق من الاتصال أو من صلاحية عرض الإعدادات.</p></div>;
  ...
  return <div className="space-y-5 font-arabic" dir="rtl">
    <div className="flex flex-col gap-4 border-b border-border/30 bg-secondary/15 p-5 sm:flex-row sm:items-center sm:justify-between">
      <div><h2 className="flex items-center gap-2 text-sm font-bold text-white"><Settings2 className="h-4 w-4 text-primary" /> إعدادات النظام</h2><p className="mt-1 text-xs text-muted-foreground">إعدادات محفوظة في قاعدة البيانات ومتصلة بمسارات التشغيل الفعلية</p></div>
